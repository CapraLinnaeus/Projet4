...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first">
            <img src="http://danielzawadzki.com/codepen/01/icon.svg" id="icon" alt="Se connecter à l'interface administrateur" />
        </div>
        ...
        if (isset($_GET['error']) && (int)$_GET['error'] == 1) { ?>
            <span style="color: red"> Identifiants incorrects</span>
        <?php }
        ?>
